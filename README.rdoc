...
Mega awesome contributing authors include: [Ian Mortier](http://github.com/healthcare) (design!), Kevin Mcphillips (code!), Chris Lobay (design!), Brittany Forsyth (places!), Courtney Symons (places!), Lisa Danay (places!), and everyone else who we collaboratively roped in to help out (love!).
...
https://github.com/edward/forage/graphs/contributors
